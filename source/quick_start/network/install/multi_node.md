...
![](D:/work/geno-docs/img/1736927887610.png)
...
validators = ["did:geno:0x160b54be617f4bff07bd6c994fc6dd17a69d5e4e","did:geno:0x837a0abd6419f681043961eea6a2d3a0ac3e76ad","did:geno:0x9103cb00dcecbe40c0e77fd400be02f0e1af3e44","did:geno:0xcf8989649d123cf715a3e0785ed2901331d26d15"]
...
asset_issuer="did:geno:0x052c4dc8f39a0dcf0024e06499cde38eb4cbdf99" 
[json_rpc]
...
[p2p]
codec_type = "default"
local_addr = "127.0.0.1:18331"
heartbeat_interval = 60
target_peer_connection = 50
max_connection = 2000
connect_timeout = 5
listen_addr = "0.0.0.0:18331"
known_peers = ["127.0.0.1:18331", "127.0.0.1:18332", "127.0.0.1:18333", "127.0.0.1:18334"]
consensus_listen_addr = "0.0.0.0:18441"
consensus_known_peers = ["127.0.0.1:18441", "127.0.0.1:18442", "127.0.0.1:18443", "127.0.0.1:18444"]
...
多节点genesis_block的validators 只能配置所有的验证节点node_address，而且所有节点上节点顺序必须保持一直

多节点p2p的known_peers和consensus_known_peers需要配置所有验证节点的监听端口和地址
